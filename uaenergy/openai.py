...
class Prompts(StrEnum):
    ...
    SELECT_TOPIC = (
        ...
        "Firstly, select the model that produced the most coherent and relevant set of topics. "
        "Secondly, give each topic a short and descriptive name in Ukrainian of no more than 5 words. "
